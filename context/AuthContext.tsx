...
type AuthContextType = {
    ...
    setRole: (role: 'MANAGER' | 'PROMOTION' | 'PROMOTION_EMPLOYEE' | "ANONYMOUS" | null | undefined) => void;
...
export const AuthProvider = ({children}: { children: ReactNode }) => {
    ...
    const [role, setRoleState] = useState<
        'MANAGER' | 'PROMOTION' | 'PROMOTION_EMPLOYEE' | 'ANONYMOUS' | null | undefined
    >(null);
    ...
    useEffect(() => {
        const loadAuthData = async () => {
            try {
                ...
                if (storedRole) setRoleState(storedRole as 'MANAGER' | 'PROMOTION' | 'PROMOTION_EMPLOYEE' | 'ANONYMOUS');
    ...
    const setRole = async (
        newRole: 'MANAGER' | 'PROMOTION' | 'PROMOTION_EMPLOYEE' | 'ANONYMOUS' | null | undefined,
    ) => {
        try {
